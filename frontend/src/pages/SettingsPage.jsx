...
const PREVIEW_MESSAGE = [
    { id: 1, content: "Whaaazaap! 🤘", isSent: false },
    { id: 2, content: "WAAAAZZZAAAAAAP! 🤘", isSent: true }
]
        ...
        <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
            <div className="space-y-6">
                <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm text-base-content/29">Choose a theme for your chat interface</p>
                </div>
