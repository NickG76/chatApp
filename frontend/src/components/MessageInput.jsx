...
const MessageInput = () => {
  ...
  const handleImageChange = (e) => {
    ...
    if (!file.type.startsWith("image/")) {
      toast.error("C'mon, that's not an image!")
      return
    }
    ...
    <div className="p-4 w-full">
      ...
      <form onSubmit={handleSendMessage} className="flex items-center gap-2">
        <div className="flex-1 flex gap-2">
          <input type="text" className="w-full input input-bordered rounded-lg input-sm sm:input-md" placeholder="Send 'em a message..." value={text} onChange={(e) => setText(e.target.value)} />
